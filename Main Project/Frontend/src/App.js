...
import OwnerTransaction from './components/owner/ownertransactions';
import AllTransaction from './components/admin/alltransactions';
  ...
  return (
    ...
    <div>
      <Routes>
        ...
        <Route path='/userhome/usertransactions'element={<ProtectedRoutes Component = {UserTransaction}/>}></Route>
        <Route path='/ownerhome/ownertransactions'element={<ProtectedRoutes Component = {OwnerTransaction}/>}></Route>
        <Route path='/admin/alltransactions'element={<ProtectedRoutes Component = {AllTransaction}/>}></Route>
