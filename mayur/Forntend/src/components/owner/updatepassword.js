...
export default function UpdatePasswordOwner() {
  const init = {
  ...
  const submitData = (e) => {
    ...
    e.preventDefault();
    axios
      .post("http://localhost:8080/updatepass", {
      ...
      <div className="container mt-5  col-md-4 bg-light needs-validation pb-5 pt-5 rounded">
        ...
        <div class="input-group has-validation">
          ...
          <input
            type="password"
            className={
              cust.oldpassword.touch
                ? cust.oldpassword.valid
                  ? "form-control is-valid"
                  : "form-control is-invalid"
                : "form-control"
            }
          ...
          <div
            className={
              cust.oldpassword.valid ? "valid-feedback" : "invalid-feedback"
            }
          >
        ...
        <div class="input-group has-validation">
          ...
          <input
            type="password"
            className={
              cust.newpassword.touch
                ? cust.newpassword.valid
                  ? "form-control is-valid"
                  : "form-control is-invalid"
                : "form-control"
            }
          ...
          <div
            className={
              cust.newpassword.valid ? "valid-feedback" : "invalid-feedback"
            }
          >
        ...
        <div class="input-group has-validation">
          ...
          <input
            type="password"
            className={
              cust.confirmnewpassword.touch
                ? cust.confirmnewpassword.valid
                  ? "form-control is-valid"
                  : "form-control is-invalid"
                : "form-control"
            }
            ...
            required
            value={cust.confirmnewpassword.value}
            onChange={(e) => {
