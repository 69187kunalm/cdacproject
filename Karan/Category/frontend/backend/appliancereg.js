...
const OwnerForm = () => {
  ...
  const submitAppData = (e) => {
    ...
    axios
      .post("http://localhost:8080/saveappliance", {
      ...
      .then(
        (response) => {
          if (response.data.length != 0) {
            ...
            axios
              .post(
                "http://localhost:8080/uploadimage/" + response.data.app_id,
                formData,
                {
                  headers: {
            ...
            <div className="col-md-12 text-center bg-light p-4">
              <form>
                ...
                <div className="mb-3 row">
                  ...
                  <div
                    className={
                      data.appname.valid ? "valid-feedback" : "invalid-feedback"
                    }
                  >
                    {data.appname.error}
                  </div>
                ...
                <div class="mb-3 row">
                  <label for="desc" class="col-sm-4 col-form-label text-center">
                ...
                <div class="input-group mb-3">
                  ...
                  <div
                    className={
                      data.price.valid ? "valid-feedback" : "invalid-feedback"
                    }
                  >
                    {data.price.error}
                  </div>
              ...
              <div
                className={
                  msg2 === "Image upload succesfully"
                    ? "alert alert-primary mt-5"
                    : "alert alert-danger mt-5"
                }
                role="alert"
                style={{ display: msg2 != "" ? "block" : "none" }}
              >
                {msg2}
              </div>
            </div>
