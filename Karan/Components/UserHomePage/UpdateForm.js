          ...
          <div className="col-md-6 text-center">
            ...
            <div className="col-md-12 text-center bg-light p-4">
              <form>
                ...
                <div className="mb-3 row">
                  <label for="con" class="col-sm-4 col-form-label text-center">
                    Contact No :
                  </label>
                  <div className="col-sm-8">
                ...
                <div className="mb-3 row">
                  <label for="city" class="col-sm-4 col-form-label text-center">
                    City :
                  </label>
                  <div className="col-sm-8">
                ...
                <div className="mb-3 row">
                  <label for="pin" class="col-sm-4 col-form-label text-center">
                    Pin Code :
                  </label>
                  <div className="col-sm-8">
