...
const RegisterForm = () => {
  ...
  const handleChange = (f, v) => {
    ...
    dispatch({
      type: "update",
      fld: f,
      val: { value: v, valid: ch, touch: true, error: msg },
    });
  };
    ...
    <div>
      ...
      <div className="container mt-5  col-md-4 bg-light needs-validation pb-5 pt-5 rounded">
        <div className="row">
          ...
          <div
            className="col justify-content-center mt-3 mb-3 pt-4 pb-4"
        ...
        <div className="row">
          <div class="col-md">
            ...
            <input
              type="text"
              className={
                cust.firstname.touch
                  ? cust.firstname.valid
            ...
            <div
              className={
                cust.firstname.valid ? "valid-feedback" : "invalid-feedback"
              }
            >
          ...
          <div class="col-md">
            ...
            <div
              className={
                cust.lastname.valid ? "valid-feedback" : "invalid-feedback"
              }
            >
              {cust.lastname.error}
            </div>
        ...
        />
        <div
          className={cust.email.valid ? "valid-feedback" : "invalid-feedback"}
        >
          {cust.email.error}
        </div>
        ...
        <div class="input-group has-validation">
          ...
          <div
            className={
              cust.mobileno.valid ? "valid-feedback" : "invalid-feedback"
            }
          >
            {cust.mobileno.error}
          </div>
        ...
        <div class="input-group has-validation">
          ...
          <div
            className={
              cust.password.valid ? "valid-feedback" : "invalid-feedback"
            }
          >
            {cust.password.error}
          </div>
        ...
        <div class="input-group has-validation">
          ...
          <input
            type="password"
            className={
              cust.confirmpassword.touch
                ? cust.confirmpassword.valid
                  ? "form-control is-valid"
                  : "form-control is-invalid"
                : "form-control"
            }
            ...
            required
            value={cust.confirmpassword.value}
            onChange={(e) => {
          ...
          <div
            className={
              cust.confirmpassword.valid ? "valid-feedback" : "invalid-feedback"
            }
          >
